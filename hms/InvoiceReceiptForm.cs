...
namespace HMS.Forms
{
    public partial class InvoiceReceiptForm : Form
    {
        ...
        private void LoadInvoiceDetails()
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    {
                        // No data found, revert to debug ID or clear fields
        ...
        private string[] GetDataReaderColumnNames(SqlDataReader reader)
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Absolute, 200)); // Header
            this.tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 100F)); // Line items
            this.tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Absolute, 60)); // Footer
